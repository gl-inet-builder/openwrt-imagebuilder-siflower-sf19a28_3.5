    ...
    var vueComponent = Vue.extend({
        ...
        computed: {
            ...
            vpnstatus: function vpnstatus() {
                return this.router_vpn && this.router_vpn['openvpn_client'] || {};
            },
            ssstatus: function ssstatus() {
                return this.router_vpn && this.router_vpn['shadowsocks_client']&& this.router_vpn['shadowsocks_client']['status'] || false;
            },
            wrstatus: function wrstatus() {
                return this.router_vpn && this.router_vpn['wireguard_client'] || {};
            },
            ...
            share: function share() {
                return this.router.model != 'vixmini' && this.router.model != 'usb150' && this.router.model != 'n300' && this.router.model != 'x300b';
            },
        ...
        watch: {
            getaps: {
                handler: function (val, oldval) {
                    if (this.wifiInitStatus.wifi != undefined && this.wifiInitStatus.wifi == false) {
